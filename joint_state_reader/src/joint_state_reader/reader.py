...
class JointStateReader(object):                                                                        
    ...
    # update joint values
        for i, joint in enumerate(data.name):
            self.joint_states[joint] = data.position[i]
    ...
    def get_joints(self, names):                                                                       
        ...
        """                                                                     
        values = [self.joint_states[name] if name in self.joint_states else None for name in names]
        # for joint_name in names:
        #     if joint_name in joint_states:
        #         values.append(joint_states[joint_name])
        #     else:
        #         values.append(None)
