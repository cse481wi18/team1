...
def transform_to_pose(matrix):
    ...
    q = tft.quaternion_from_matrix(matrix) # turn matrix into quaternion
    pose.orientation = Quaternion(q[0], q[1], q[2], q[3])
    # tft.quaternion_matrix([x, y, z, w]) # returns homogenous rotation matrix from quaternion 
